...
export default function HeroSection() {
  return (
    <div className="py-4 flex flex-col gap-14 lg:gap-36">
      <div className="px-4 max-w-screen-xl mx-auto flex flex-col gap-5 lg:gap-40 lg:gap-y-10 lg:grid lg:grid-cols-2 lg:grid-rows-[auto_auto]">
        ...
        <div className="mx-auto w-fit lg:col-start-2 lg:col-end-3 lg:row-span-2">
          <Portrait />
        </div>
